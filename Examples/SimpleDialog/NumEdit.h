...
// Attributes
public:
	enum {VALID = 0x00, OUT_OF_RANGE_MAX = 0x01, INVALID_CHAR = 0x02, MINUS_PLUS = 0x03, OUT_OF_RANGE_MIN = 0x08};
// Operations
public:
...
public:
	...
	virtual void SetNumberOfNumberAfterPoint(BYTE nNumberOfNumberAfterPoint);
	virtual void Verbose(BOOL v);
	virtual BOOL Verbose()const; 
	virtual int IsValid(BOOL show_message)const; 
	virtual int IsValidSymble()const; 
